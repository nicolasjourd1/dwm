...
static const Key keys[] = {
	...
	{ 0,              XF86XK_AudioLowerVolume, spawn,          SHCMD("sound.sh --dec") },
	{ 0,              XF86XK_AudioRaiseVolume, spawn,          SHCMD("sound.sh --inc") },
	{ 0,                     XF86XK_AudioMute, spawn,          SHCMD("sound.sh --mute") },
